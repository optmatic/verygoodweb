...
export default function SimpleContent({
  ...
  return (
    <div>
      {/* <div className="mx-auto max-w-7xl py-12 px-6 md:px-0"> */}
      <div className="mx-auto max-w-7xl py-12 px-0 md:px-0">
      {/* <div className="mx-auto intro max-w-2xl lg:mx-0 lg:max-w-none"> */}

        <div className="mx-auto intro max-w-none lg:mx-0">
          ...
          <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base/7 text-gray-700 md:grid-cols-2 md:max-w-none">
            <div>
